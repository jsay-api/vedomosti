...
class Beneficiary(models.Model):
	ben_name = models.CharField(verbose_name = "имя", max_length = 20)
	ben_lastname = models.CharField(verbose_name = "фамилия", max_length = 30)
...
class AssetsBeneficiaries(models.Model):
	...
	rel_date = models.DateField(verbose_name = "дата актуальности", auto_now_add = True, blank = True)
	source = models.CharField(verbose_name = "источник", max_length = 40, blank = True)
